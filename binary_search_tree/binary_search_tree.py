...
class BSTNode:
    ...
    def post_order_dft(self):
        # traverse as far down as possible, favoring the left node
        # when no more moves are possible, print the value
        # unwind back up until a new move is possible and repeat
        if self.left:
